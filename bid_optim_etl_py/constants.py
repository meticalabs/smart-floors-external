...
APPLOVIN_MANAGEMENT_API_KEYS = json.loads(json.loads(SecretsManagerHelper(DEFAULT_AWS_REGION).get_secret("prod/appLovinManagmentkeys"))["applovin-management-api-keys"])