...
def format_s3_key(prefix: str, customer_id: int, app_id: int, date_str: str, platform: str, ad_type: str) -> str:
    """Format S3 key for bid floor percentiles."""
    return f"{prefix}/{customer_id}/{app_id}/{date_str}_{platform}_{ad_type}.json"
